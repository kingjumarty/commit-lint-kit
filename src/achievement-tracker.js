 ...
 * Shows badge progress for Commit Lint Kit and a Day 1 -> Month 1 roadmap.
 * Usage:
...
function printBadgeTable() {
  console.log('=== Commit Lint Kit — Achievement Badge Progress ===\n');
...
function printRoadmap() {
  console.log('=== Commit Lint Kit — Day 1 -> Month 1 Roadmap ===\n');
  const roadmap = [
